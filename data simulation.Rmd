...
>>>>>>> 6d52d10b0a71fa8407125820a81b392a8d9c562d
...
for (i in 1:1000){
  for(j in 1:9){
    ...
    dbias[j,1]=mean(dfi[,j])
    dbias[j,2]=mean(dfc[,j])
    dbias[j,3]=mean(dfiv[,j])
  }
}
...
We select three 
```{r, analysis}
r_df10_1i=ideal_model_b(df10_1)
r_df20_1i=ideal_model_b(df20_1)
r_df30_1i=ideal_model_b(df30_1)
=======
...
row.names(dpb)=c("pp=0.3,uc=0.3","pp=0.3,uc=0.4","pp=0.3,uc=0.5","pp=0.5,uc=0.3","pp=0.5,uc=0.4","pp=0.5,uc=0.5","pp=0.7,uc=0.3","pp=0.7,uc=0.4","pp=0.7,uc=0.5")
colnames(dpb)=c("IV model","Conventional model")

<<<<<<< HEAD
bias_b(df10_1,summary(r_df10_1i)$coefficients[6])
bias_b(df10_1,summary(r_df10_1c)$coefficients[6])
```
