...
for (i in 1:1000){
  for(j in 1:9){
    dfi[i,j]=RMSE(df40000[[j]]$W, ideal_model(samp(df40000[[j]]))$fitted.values)
    dfc[i,j]=RMSE(df40000[[j]]$W, conv_model(samp(df40000[[j]]))$fitted.values)
    dfiv[i,j]=RMSE(df40000[[j]]$W,IV_model(samp(df40000[[j]]))$fitted.values)
...
row.names(drmse_40000)=c("pp=0.3,uc=0.3","pp=0.3,uc=0.4","pp=0.3,uc=0.5","pp=0.5,uc=0.3","pp=0.5,uc=0.4","pp=0.5,uc=0.5","pp=0.7,uc=0.3","pp=0.7,uc=0.4","pp=0.7,uc=0.5")
...
row.names(dpb_40000)=c("pp=0.3,uc=0.3","pp=0.3,uc=0.4","pp=0.3,uc=0.5","pp=0.5,uc=0.3","pp=0.5,uc=0.4","pp=0.5,uc=0.5","pp=0.7,uc=0.3","pp=0.7,uc=0.4","pp=0.7,uc=0.5")
...
colnames(iv40000)=c("pp=0.3,uc=-0.07","pp=0.3,uc=-0.08","pp=0.3,uc=-0.09","pp=0.5,uc=-0.07","pp=0.5,uc=-0.08","pp=0.5,uc=-0.09","pp=0.7,uc=-0.07","pp=0.7,uc=-0.08","pp=0.7,uc=-0.09")
